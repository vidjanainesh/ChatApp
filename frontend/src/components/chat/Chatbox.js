...
export default function Chatbox() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-white to-indigo-50 p-4">
      <div className="w-full max-w-md mx-auto flex flex-col h-[80vh] sm:h-[95vh] px-2 sm:px-4 rounded-lg shadow-md">
        ...
        <form
          ...
          className="flex items-end gap-2 bg-white p-2 rounded-lg mb-2.5 shadow-md"
        >
          <textarea
            value={input}
