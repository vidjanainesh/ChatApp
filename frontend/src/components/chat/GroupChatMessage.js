                    ...
                    >
                        ...
                        <div className="text-left">
                            {msg?.isDeleted ? (
                                ...
                                <>
                                    {msg?.repliedMessage && (
                                        <div className="border-l-4 border-blue-300 pl-2 mb-2 mt-2 text-xs text-gray-600 max-h-20 overflow-hidden text-ellipsis line-clamp-3">
                                    ...
                                    {msg?.fileType && msg?.fileType !== "image" && msg?.fileType !== "video" && (
                                        <div className="relative mb-2 w-fit mt-0.5">
                                            <div
                        ...
                        {msg?.reactions && msg?.reactions.length > 0 && !msg?.isDeleted && (
                            <div className={`absolute -bottom-2 ${isSender ? '-left-2' : '-right-2'} flex gap-1 flex-nowrap`}>
                                {Object.entries(
